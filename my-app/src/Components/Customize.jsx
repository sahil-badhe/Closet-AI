    ...
    <div className="mb-12">
      <div className="flex justify-between mb-2">
        {Array.from({ length: totalSteps }).map((_, index) => (
          <div
            key={index}
            className={`flex items-center justify-center w-10 h-10 rounded-full transition-all ${completed.includes(index + 1)
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {options.map((option) => (
        <motion.button
          ...
          className={`relative overflow-hidden rounded-3xl transition-all ${(isMultiSelect && selectedItems.includes(option.id)) ||
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      {skinTones.map((tone) => (
        <motion.button
          ...
          className={`p-4 rounded-xl text-center transition-all ${selectedSkinTone === tone.value
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      {seasons.map((season) => (
        <motion.button
          ...
          className={`relative overflow-hidden rounded-2xl transition-all ${selectedSeason === season.value
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      {ageGroups.map((age) => (
        <motion.button
          ...
          className={`p-4 rounded-2xl text-center transition-all ${selectedAge === age.value
            ? "ring-2 ring-indigo-500 ring-offset-2 bg-indigo-50"
            : "bg-white hover:bg-gray-50"
            }`}
          whileHover={{ scale: 1.03 }}
          ...
          {step !== 6 && (
            <div className="flex justify-between mt-12">
              <motion.button
                ...
                className={`flex items-center px-5 py-2.5 rounded-2xl font-medium ${step === 1
