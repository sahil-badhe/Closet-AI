      ...
      <div className="bg-white p-8 rounded-3xl shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSignup}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full bg-indigo-600 text-white py-2 px-4 rounded-2xl hover:bg-indigo-700 transition-colors flex justify-center items-center ${isLoading ? 'opacity-75 cursor-not-allowed' : ''
              }`}
          >
            {isLoading ? (
              <>
